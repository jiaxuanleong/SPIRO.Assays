...
Each assay comprises of three major steps. <b>Detailed information for the implementation of each step is provided in the corresponding folders of the repository</b>:
<ol>
